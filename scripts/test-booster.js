// Script de test pour vérifier l'achat de boosters et la création de NFTs
...
async function main() {
  ...
  try {
    ...
    console.error("Erreur lors de la lecture des adresses de contrats. Assurez-vous d'avoir exécuté le script de déploiement.");
    process.exit(1);
  }
  ...
  console.log("\nTest d'achat de booster terminé avec succès!");
}
