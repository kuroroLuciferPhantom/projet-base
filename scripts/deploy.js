// Script de déploiement des contrats EFC (Epic Faction Community)
...
async function main() {
  ...
  console.log("Balance du déployeur:", ethers.utils.formatEther(await deployer.getBalance()));
  ...
  // 5. Distribution de tokens aux utilisateurs de test
  ...
  console.log("Adresses des contrats enregistrées dans deployed-contracts.json");
